...
## AI image bot  
Uses DALL-E 3 image api to generate images when someone says !generateimage [prompt] (if that's too long, just change it in the script) 
...
Get a API token at [OpenAI](https://platform.openai.com)  
